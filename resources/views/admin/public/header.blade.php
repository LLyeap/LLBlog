        ...
        <ul class="nav navbar-nav navbar-right top-menu top-right-menu">
            ...
            <li class="dropdown text-center">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <span class="username">用户：{{Session::get('user')->email}}</span> <span class="caret"></span>
                </a>
                <ul class="dropdown-menu pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                    <li><a href="javascript:;"><i class="fa fa-briefcase"></i>你好！欢迎来到李雷的博客后台管理系统！</a></li>
                    <li><a href="javascript:;"><i class="fa fa-cog"></i>最后一次登陆IP：<span style="text-decoration:underline;">{{Session::get('user')->ip}} </span> </a></li>
                    <li><a href="javascript:;"><i class="fa fa-bell"></i>最后一次登陆时间：<span style="text-decoration:underline;"> {{date('Y年m月d日 H:i:s',Session::get('user')->logintime)}} </span> </a></li>
